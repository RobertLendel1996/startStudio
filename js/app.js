(() => {
    ...
    (() => {
        ...
        function menuInit() {
            ...
            if (document.querySelector(".burger-menu__text")) document.addEventListener("click", (function(e) {
                if (bodyLockStatus && e.target.closest(".burger-menu__text")) {
                    bodyLockToggle();
                    document.documentElement.classList.toggle("menu-open");
                }
            }));
        ...
        function initSliders() {
            ...
            if (document.querySelector(".main-design__slider")) new core(".main-design__slider", {
                modules: [ Pagination, Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                speed: 800,
                pagination: {
                    el: ".main-design__slider .swiper-pagination",
                    clickable: true
                },
                navigation: {
                    prevEl: ".main-design__slider .swiper-button-prev",
                    nextEl: ".main-design__slider .swiper-button-next"
                },
                on: {}
            });
        }
